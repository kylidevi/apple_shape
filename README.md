...
<ul>
  ...
  <li>Figure2&5.R: code pertaining to the creation of the figures 2 and 4</li>
  <li>TableS2.R: code pertaining to the Spearman rank and Bonferroni correction</li>
  ...
  <li>TableS1.csv: results from the analysis</li>
</ul>
